...
It is important to know that the GO-related files and the Cypress core infrastructure is in 2 independent directories. So it is possible to upgrade Cypress core without any change in the GO-related files.
