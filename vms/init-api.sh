...
echo "CACHE_MIDDLEWARE_SECONDS=$CACHE_MIDDLEWARE_SECONDS" >> .tmp/env
...
echo "AUTO_TRANSLATION_TRANSLATOR=$AUTO_TRANSLATION_TRANSLATOR" >> .tmp/env
echo "IFRC_TRANSLATION_DOMAIN=$IFRC_TRANSLATION_DOMAIN" >> .tmp/env
echo "IFRC_TRANSLATION_GET_API_KEY=$IFRC_TRANSLATION_GET_API_KEY" >> .tmp/env
echo "IFRC_TRANSLATION_HEADER_API_KEY=$IFRC_TRANSLATION_HEADER_API_KEY" >> .tmp/env
